...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GoogleMediaFramework/GoogleMediaFramework.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GoogleToolboxForMac/GoogleToolboxForMac.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GoogleUtilities/GoogleUtilities.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LNPopupController/LNPopupController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Masonry/Masonry.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ObjectiveCDM/ObjectiveCDM.framework"
