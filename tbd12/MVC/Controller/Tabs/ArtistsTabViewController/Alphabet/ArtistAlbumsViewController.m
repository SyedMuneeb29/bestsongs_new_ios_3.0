...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = [NSString stringWithFormat:@"%@%@", @"Artists > ", _selectedAlphabet];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.imageView sd_setImageWithURL:[NSURL URLWithString:artist.Poster]
...
- (void) retrieveData {
    @try {
        ...
        [[BestsongsAPI sharedInstance] fetchArtistAlphabet:self.selectedAlphabet page:[NSNumber numberWithInteger:currentPage] onSuccess:^(id response) {
            ...
            dispatch_async(dispatch_get_main_queue(), ^ {
                ...
                if(!isDataLoaded){
                    ...
                    /*__weak ArtistAlbumsViewController *weakSelf = self;
...
- (void) pullToRefreshData{
    @try {
        ...
        [[BestsongsAPI sharedInstance] fetchArtistAlphabet:self.selectedAlphabet page:[NSNumber numberWithInteger:1] onSuccess:^(id response) {
            NSDictionary *dataDictionary = (NSDictionary *) response;
