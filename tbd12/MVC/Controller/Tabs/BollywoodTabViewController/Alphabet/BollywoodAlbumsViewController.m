//
//  BollywoodAlbumsViewController.m
//  Bestsongs.pk
//
...
@interface BollywoodAlbumsViewController () {
...
@implementation BollywoodAlbumsViewController
@synthesize selectedAlphabet , TableView;

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.backBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"" style:UIBarButtonItemStylePlain target:nil action:nil];
    self.navigationItem.title = [NSString stringWithFormat:@"%@%@", @"Bollywood > ", selectedAlphabet];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *cellID = @"BollywoodAlbumCell";
...
- (void) retrieveData {
    @try {
        ...
        [[BestsongsAPI sharedInstance] fetchBollywoodAlbum:self.selectedAlphabet page:[NSNumber numberWithInteger:currentPage] onSuccess:^(id response) {
            ...
            dispatch_async(dispatch_get_main_queue(), ^ {
                ...
                if(!isDataLoaded){
                    ...
                    /*__weak BollywoodAlbumsViewController *weakSelf = self;
...
- (void) pullToRefreshData{
    @try {
        ...
        [[BestsongsAPI sharedInstance] fetchBollywoodAlbum:self.selectedAlphabet page:[NSNumber numberWithInteger:1] onSuccess:^(id response) {
            NSDictionary *dataDictionary = (NSDictionary *) response;
            NSMutableArray *dataAlbums = [[NSMutableArray alloc] initWithArray:[[BestsongsAPI sharedInstance] getAlbumsArrayFromJSON:dataDictionary[@"albums"]]];
            dispatch_async(dispatch_get_main_queue(), ^ {
                currentPage = 2;
