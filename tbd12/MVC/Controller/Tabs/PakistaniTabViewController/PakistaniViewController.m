...
@interface PakistaniViewController () {
...
@implementation PakistaniViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"Pakistani";
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    if(collectionView == _CollectionView){
        static NSString *CellIdentifier = @"PakistaniCell";
    ...
    static NSString *CellIdentifier = @"PakistaniAlphabetsCell";
...
//        [[BaseController sharedInstance] showToastError:INTERNTERRORMESSAGE];
    ...
    if(collectionView == self.CollectionView){
        ...
        PakistaniAlbumsViewController * pavc = [self.storyboard instantiateViewControllerWithIdentifier:@"pakistaniAlbumViewController"];
        pavc.selectedAlphabet = selectedAlphabet;
...
- (void) retrieveData {
    @try {
        ...
        [[BestsongsAPI sharedInstance] fetchPakistani:[NSNumber numberWithInteger:currentPage] onSuccess:^(id response) {
...
- (void) pullToRefreshData{
    @try {
        [[BestsongsAPI sharedInstance] fetchPakistani:[NSNumber numberWithInteger:1] onSuccess:^(id response) {
            NSDictionary *dataDictionary = (NSDictionary *) response;
            NSMutableArray *dataAlbums = [[NSMutableArray alloc] initWithArray:[[BestsongsAPI sharedInstance] getAlbumsArrayFromJSON:dataDictionary[@"albums"]]];
            dispatch_async(dispatch_get_main_queue(), ^ {
                currentPage = 2;
