...
- (void)addPullToRefreshWithActionHandler:(void (^)(void))actionHandler topMargin:(CGFloat)topMargin position:(SVPullToRefreshPosition)position{
    if(!self.pullToRefreshView) {
        ...
        view.originalTopInset = topMargin == 0.0 ? self.contentInset.top : 65;
...
- (void)addPullToRefreshWithActionHandler:(void (^)(void))actionHandler topMargin:(CGFloat)topMargin{
    [self addPullToRefreshWithActionHandler:actionHandler topMargin:topMargin position:SVPullToRefreshPositionTop];
}
