    ...
    if([aImageUrls count] > 0) {
        ...
        for (int i = 0; i < [aImageUrls count]; i++) {
            ...
            if ([_dataSource respondsToSelector:@selector(placeHolderImageForImagePager:)]) {
                ...
                /*[smallImageView setImage:[_dataSource placeHolderImageForImagePager:self]];*/
            }
            if([_dataSource respondsToSelector:@selector(contentModeForPlaceHolder:)]) {
                ...
                /*[smallImageView setContentMode:[_dataSource contentModeForPlaceHolder:self]];*/
            }
            ...
            if([[aImageUrls objectAtIndex:i] isKindOfClass:[UIImage class]]) {
                ...
                /*[smallImageView setImage:(UIImage *)[aImageUrls objectAtIndex:i]];*/
                ...
                /*[imageView addSubview:visualEffectView];*/ // Replace This Code With Next Line
                [imageView addSubview:activityIndicator];
                
                /*[visualEffectView addSubview:activityIndicator];
                [visualEffectView addSubview:smallImageView];*/
