...
static const CGFloat kBarIdleHeight = 5.0;

static const CGFloat kHorizontalBarSpacing = 3.0; // Measured on iPad 2 (non-Retina)
static const CGFloat kRetinaHorizontalBarSpacing = 2.5; // Measured on iPhone 5s (Retina)

static const CGFloat kBarMinPeakHeight = 5.0;
static const CGFloat kBarMaxPeakHeight = 25.0;
